...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "Where your brainpower unlocks BIG wins\\! 💸🔥\n\n"
        "🧠 Just Answer a quick *Trivia Question*\n\n"
        "💎 And *You* could win amazing prizes like:\n\n"
        "•*📱 iPhone 16 Pro Max*\n\n"
        "•*📱 iPhone 17 Pro Max*\n\n"
...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "⏳ You have only *20 seconds* to choose an answer\n\n"
        ...
        "• Tap 📊 *Available Tries* → To track your spin balance\n\n"

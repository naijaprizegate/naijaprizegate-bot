# ==============================================================
# migrations/init_tables.py (SAFE VERSION with schema tracking)
# ==============================================================
import os
import json
...
def main():
    ...
    try:
        ...
        # ======================================================
        # 2. Prize Winners — NO DROPPING ANYMORE ✅
        # ======================================================
        cur.execute("""
        ...
        # ======================================================
        # ✅ Record success in schema migrations
        # ======================================================
        meta = json.dumps({
            "applied_by": "render_deploy",
